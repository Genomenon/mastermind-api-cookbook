...
def main():
    ...
    response = requests.get(
        url=URL + "suggestions", params={"api_token": API_TOKEN, "variant": variant}
    )
    ...
    print(
        "Mastermind link: https://mastermind.genomenon.com/detail?disease=all%20diseases&mutation="
        + encoded_match
    )
    ...
    for match in data:
        ...
        count_response = requests.get(
            url=URL + "counts", params={"api_token": API_TOKEN, "variant": canonical}
        )
